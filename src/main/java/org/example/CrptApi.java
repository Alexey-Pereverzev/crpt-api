...
public class CrptApi {
    ...
    private final ExecutorService executorService = Executors.newFixedThreadPool(POOL_SIZE);        //  thread pool
    ...
    public CrptApi(TimeUnit timeUnit, int requestLimit) {
        ...
        this.msDelay = roundUpDivision(timeUnit.toMillis(1), POOL_SIZE);
    }
    ...
    public static class ProductRegistration {
        ...
        public ProductRegistration(String participantInn, String docId, String docStatus, String docType, 
            ...
            this.description = new ProductRegistration.Description(participantInn);
            this.docId = docId;
    ...
    private void sendPostRequest(ProductRegistration registration, String signature) {
        if (requestSemaphore.tryAcquire()) {
            ...
            logger.info("Request limit exceeded. Cannot send request at this time");
        }
    }
